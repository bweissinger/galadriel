...
def add_objects_to_db(database):
    ...
    models.append(
        database.Race(race_num=2,
                      ...
                      meet_id=1))
    models.append(
        database.Runner(name='a', morning_line='1/9', tab=1, race_id=1))
    models.append(
        database.Runner(name='b', morning_line='1/9', tab=2, race_id=1))
    models.append(
        database.Runner(name='c', morning_line='1/9', tab=1, race_id=2))
    models.append(
